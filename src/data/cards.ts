    ...
    effects: [
      {
        ...
        target: 'randomEnemy',
        damage: 1,
        description: '[Compra] Inflige 1 de dano a un enemigo aleatorio si existe.',
      },
    ],
    artKey: 'placeholder_arcane_spark',
    playerText: '[Compra] Inflige 1 de dano aleatorio.',
  },
  {
    ...
    effects: [
      {
        ...
        description: '[Muerte] Invoca un Esqueleto 1/1.',
      },
    ],
    artKey: 'placeholder_undead_bonecaller',
    playerText: '[Muerte] Invoca un Esqueleto 1/1.',
  },
  {
    ...
    effects: [
      {
        ...
        health: 0,
        permanent: false,
        description: '[Inicio Combate] Un aliado aleatorio gana +1 ataque.',
      },
    ],
    artKey: 'placeholder_beast_alpha',
    playerText: '[Inicio Combate] Un aliado aleatorio gana +1 ataque.',
  },
  {
    ...
    effects: [
      {
        ...
        health: 0,
        permanent: true,
        description: '[Fin Tienda] Gana +1 ataque permanente.',
      },
    ],
    artKey: 'placeholder_undead_gravedigger',
    playerText: '[Fin Tienda] Gana +1 ataque permanente.',
  },
  {
    ...
    effects: [
      {
        ...
        health: 1,
        permanent: true,
        description: '[Compra] Un aliado aleatorio gana +1/+1 permanente.',
      },
    ],
    artKey: 'placeholder_elemental_kindler',
    playerText: '[Compra] Un aliado aleatorio gana +1/+1.',
  },
  {
    ...
    effects: [
      {
        ...
        target: 'randomEnemy',
        damage: 2,
        description: '[Inicio Combate] Inflige 2 de dano a un enemigo aleatorio.',
      },
    ],
    artKey: 'placeholder_arcane_elemental_orb',
    playerText: '[Inicio Combate] Inflige 2 de dano aleatorio.',
  },
  {
    ...
    effects: [
      {
        ...
        target: 'randomEnemy',
        damage: 2,
        description: '[Muerte] Inflige 2 de dano a un enemigo aleatorio.',
      },
    ],
    artKey: 'placeholder_undead_revenant',
    playerText: '[Muerte] Inflige 2 de dano aleatorio.',
  },
];
